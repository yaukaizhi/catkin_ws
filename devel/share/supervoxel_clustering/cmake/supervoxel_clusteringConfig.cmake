...
if(supervoxel_clustering_CONFIG_INCLUDED)
  return()
endif()
set(supervoxel_clustering_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(supervoxel_clustering_SOURCE_PREFIX /home/kai/catkin_ws/src/Fast-3D-Pointcloud-Segmentation)
  set(supervoxel_clustering_DEVEL_PREFIX /home/kai/catkin_ws/devel)
  set(supervoxel_clustering_INSTALL_PREFIX "")
  set(supervoxel_clustering_PREFIX ${supervoxel_clustering_DEVEL_PREFIX})
else()
  set(supervoxel_clustering_SOURCE_PREFIX "")
  set(supervoxel_clustering_DEVEL_PREFIX "")
  set(supervoxel_clustering_INSTALL_PREFIX /home/kai/catkin_ws/install)
  set(supervoxel_clustering_PREFIX ${supervoxel_clustering_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'supervoxel_clustering' is deprecated")
...
set(supervoxel_clustering_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/kai/catkin_ws/src/Fast-3D-Pointcloud-Segmentation/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/opencv4 " STREQUAL " ")
  set(supervoxel_clustering_INCLUDE_DIRS "")
  set(_include_dirs "/home/kai/catkin_ws/src/Fast-3D-Pointcloud-Segmentation/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND supervoxel_clustering_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kai/catkin_ws/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(supervoxel_clustering_LIBRARY_DIRS ${lib_path})
      list(APPEND supervoxel_clustering_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'supervoxel_clustering'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND supervoxel_clustering_LIBRARIES ${lib})
    endif()
  endif()
...
set(supervoxel_clustering_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${supervoxel_clustering_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 supervoxel_clustering_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${supervoxel_clustering_dep}_FOUND)
      find_package(${supervoxel_clustering_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${supervoxel_clustering_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(supervoxel_clustering_INCLUDE_DIRS ${${supervoxel_clustering_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(supervoxel_clustering_LIBRARIES ${supervoxel_clustering_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${supervoxel_clustering_dep}_LIBRARIES})
  _list_append_deduplicate(supervoxel_clustering_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(supervoxel_clustering_LIBRARIES ${supervoxel_clustering_LIBRARIES})

  _list_append_unique(supervoxel_clustering_LIBRARY_DIRS ${${supervoxel_clustering_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(supervoxel_clustering_EXPORTED_TARGETS ${${supervoxel_clustering_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${supervoxel_clustering_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
